...
(function (LunrSwe) {
    ...
    step1alist = _.sortBy(step1alist, function (w) {
        return -w.length;
    });
    ...
    */
    function stemmer(w) {
        ...
        // Step 1
        var suffix = _.find(step1alist, function (su) {
            return endsWith(r1, su);
        });
        if (suffix) {
            r1 = trimEnd(r1, suffix.length);
        } else if (endsWith(r1, "s") && _.any(step1sending, function (su) {
            return endsWith(w, su + "s");
        })) {
            r1 = trimEnd(r1, 1);
        }

        // Step 2
        if (_.any(step2list, function (su) {
            return endsWith(r1, su);
        })) {
            r1 = trimEnd(r1, 1);
        }
        ...
        // Step 3
        if (_.any(step3a, function (su) {
            return endsWith(r1, su);
        })) {
            r1 = trimEnd(r1, 1);
        } else {
            suffix = _.find(step3b, function (su) {
                return endsWith(r1, su);
            });
            if (suffix) {
                r1 = trimEnd(r1, suffix.length);
    ...
    function create(config) {
        ...
        idx.pipeline.add(lunr.trimmer, stopWordFilter, stemmer);
    ...
    LunrSwe.create = create;
})(LunrSwe || (LunrSwe = {}));
//# sourceMappingURL=lunrSwe.js.map
